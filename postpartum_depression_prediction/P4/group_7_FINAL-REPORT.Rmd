...
To replicate this table, we used â..dplyrâ.. package to get the "mean", "standard deviation". Two sample t-test ("t.test") was used for comparising. 
