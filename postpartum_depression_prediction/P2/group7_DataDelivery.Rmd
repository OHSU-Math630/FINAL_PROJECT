...
attr(df$nationality, 'Description') <- "The patient's nationality or country of origin at the time of pregnancy"
attr(df$nationality, 'numeric_mapping') <- "1 = Spain
2 = Argentina
3 = Chile
4 = Morocco
5 = Romania
...
attr(df$employed,"numeric_mapping")<-"1 = unemployed
2 = full-time job
3 = half-day job
4 = student
5 = work and study"
...
attr(df$occupation,'numeeric_mapping')<-'1 = unemployment
2 = Head of nurse
3 = Doctor
4 = Nurse
5 = housewife
...
attr(df$education_level,'numeric_mapping')<-"1 = primary
2 = secondary
...
attr(df$sport,'Numeric_mapping')<-'0 = No
1 = Yes'
...
attr(df$dyed_hair, "Description") <- 'designation for mothers with dyed hair during pregnancy' 
attr(df$dyed_hair,"numeric_mapping")<-"0 = dyed
1 = natural"
...
attr(df$pregnancy_method, 'Description') <- 'designation for  *spontaneous* method of fertilization and *Fertility Treatment* or artificial insemination'
attr(df$pregnancy_method, 'numeric_maping')<-'1 = spontaneously and normally
...
attr(df$postpartum_depression, 'Description') <- "Diagnosis of post-partum depression in the mother"
attr(df$postpartum_depression,'numeric_mapping')<-'1 = sindepre?
2 = condepre?'### ???? more ?
...
numeric_mapping <- 'Primer embarazo / First Pregnancy:
0 = No
1 = Yes
