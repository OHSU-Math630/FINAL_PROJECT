...
attr(c(df$depression_tri1, df$depression_tri2, df$depression_tri3), 'Description') <- 'antenatal depression during the 1st, 2nd or 3rd trimester.'
...
df_tidy <- df %>% select(age, education_level, nationality, postpartum_depression, employed, occupation, sport, sport, pet, dyed_hair, first_pregnancy, wanted_pregnancy, pregnancy_method, previous_miscarriage, fetus_sex)
